		...
		if(mysql_num_rows($q04)>0)//provjera da li je neko rezervisao knjigu
			{
				...
				$q06 = myquery("SELECT r.idrezervacija FROM rezervacija as r, primjerakknjige as p WHERE r.KnjigaOpis_idKnjigaOpis=p.idknjigaopis AND p.idprimjerakknjige=$i[1] AND r.Osoba_idOsoba='$clan'");	
